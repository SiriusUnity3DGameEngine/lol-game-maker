...
(function (global, factory) {
	(typeof exports === 'undefined' ? 'undefined' : _typeof(exports)) === 'object' && typeof module !== 'undefined' ? factory(exports) : typeof define === 'function' && define.amd ? define(['exports'], factory) : factory(global.AI = {});
  ...
  */
	...
	function Line(options) {
		...
		options.coordinates.forEach(function (n, i) {
			_this2.coordinates.push(new Coordinate({
				x: n.x,
				y: n.y,
				z: n.z
			}));
  ...
  */
	...
	function Polygon(options) {
		...
		options.coordinates.forEach(function (n, i) {
			_this3.coordinates.push(new Coordinate({
				x: n.x,
				y: n.y,
				z: n.z
			}));
  ...
  */
	...
	SvgScene.prototype.render = function () {
		...
		var svg = d3.select(this.container).append("svg").attr("width", width).attr("height", height).append("g").call(transition, p0, p1);
  ...
  */
	...
	SvgDom.prototype.render = function () {
		...
		this.el = this.parent.append('svg').attr('width', this.width).attr('height', this.height);
  ...
  */
	...
	SvgElement.prototype.renderStyle = function (selection, scope) {
		return selection.attr('stroke', scope.stroke).attr('stroke-width', scope.strokeWidth).attr('stroke-opacity', scope.strokeOpacity).attr('stroke-linecap', scope.strokeLinecap).attr('fill', scope.fill).attr('fill-opacity', scope.fillOpacity).attr('fill-rule', scope.fillRule).attr('opacity', scope.opacity).attr('style', scope.style);
	};
  ...
  */
	...
	SvgCircle.prototype.render = function () {
		this.parent.append('circle').attr('cx', this.cx).attr('cy', this.cy).attr('r', this.r).call(this.renderStyle, this);
	};
  ...
  */
	...
	SvgRect.prototype.render = function () {
		this.parent.append('rect').attr('x', this.x).attr('y', this.y).attr('width', this.width).attr('height', this.height).attr('rx', this.rx).attr('ry', this.ry).call(this.renderStyle, this);
	};
  ...
  */
	...
	SvgEllipse.prototype.render = function () {
		this.parent.append('ellipse').attr('cx', this.cx).attr('cy', this.cy).attr('rx', this.rx).attr('ry', this.ry).call(this.renderStyle, this);
	};
  ...
  */
	...
	SvgLine.prototype.render = function () {
		this.parent.append('line').attr('x1', this.x1).attr('y1', this.y1).attr('x2', this.x2).attr('y2', this.y2).call(this.renderStyle, this);
	};
  ...
  */
	...
	SvgPolyline.prototype.render = function () {
		this.parent.append('polyline').attr('points', this.points).call(this.renderStyle, this);
	};
  ...
  */
	...
	SvgPolygon.prototype.render = function () {
		this.parent.append('polygon').attr('points', this.points).call(this.renderStyle, this);
	};
  ...
  */
	...
	SvgPath.prototype.render = function () {
		this.parent.append('path').attr('d', this.d).call(this.renderStyle, this);
	};
  ...
  */
	...
	SvgGroup.prototype.render = function () {
		...
		this.el = this.parent.append('g').call(this.renderStyle, this);
		this.children.forEach(function (n) {
			n.parent = _this7.el;
			n.render.call(n);
		});
